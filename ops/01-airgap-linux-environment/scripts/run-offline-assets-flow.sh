...
CALICO_IMAGE_TAR_COUNT="$(find assets/offline-assets/kubernetes/images/calico -maxdepth 1 -name '*.tar' | wc -l | tr -d ' ')"
STORAGECLASS_IMAGE_TAR_COUNT="$(find assets/offline-assets/kubernetes/images/storageclass -maxdepth 1 -name '*.tar' | wc -l | tr -d ' ')"
