...
1. `./ASSIGNMENT.md`
2. `./README.md`
3. `prj-docs/projects/airgap-k8s/task.md`
4. `prj-docs/projects/airgap-k8s/meeting-notes/README.md`
5. 최신 `prj-docs/projects/airgap-k8s/meeting-notes/*.md`
6. `prj-docs/projects/airgap-k8s/PROJECT_AGENT.md`
...
6. 필요 시 `cat prj-docs/projects/airgap-k8s/PROJECT_AGENT.md`
